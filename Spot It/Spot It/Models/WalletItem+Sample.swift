...
extension WalletItem {
    private static func mock(_ modelo: String, _ ano: Int, _ raridade: Int, _ valor: Double, _ aceleracao: Double, edicao: String? = nil) -> WalletItem {
        WalletItem(id: UUID(), modelo: modelo, ano: ano, raridade: raridade, valorEstimadoUsd: valor, fotoUrl: "", createdAt: Date(), aceleracao0a100: aceleracao, edicaoEspecial: edicao)
    }
    ...
    static let sample: [WalletItem] = [
        ...
        mock("Mercedes-AMG GT Black Series", 2021, 9, 335_000, 3.1, edicao: "Brabus"),
        mock("Nissan Skyline GT-R R34", 1999, 9, 250_000, 4.8, edicao: "Liberty Walk"),
        mock("Rolls-Royce Wraith Black Badge", 2022, 8, 360_000, 4.4, edicao: "Mansory"),
        mock("Ferrari 488 Pista", 2019, 8, 370_000, 2.85),
        mock("Lamborghini Huracán STO", 2022, 8, 330_000, 3.0, edicao: "Mansory"),
        mock("McLaren 720S", 2020, 7, 310_000, 2.9, edicao: "Novitec"),
